...
function sendMail() {
  ...
  var params = {
    ...
    // subject: document.getElementById("company").value,
  };

  const serviceID = "service_aozsgrb";
  const templateID = "template_kaf57em";
